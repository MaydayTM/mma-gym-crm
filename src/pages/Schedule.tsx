...
export function Schedule() {
  return (
    <div className="space-y-6 max-w-[1600px]">
      ...
      >
        <div className="w-16 h-16 mx-auto bg-sky-500/10 rounded-2xl flex items-center justify-center mb-4">
          <Calendar className="text-sky-300" size={28} strokeWidth={1.5} />
        </div>
        <h3 className="text-[20px] font-medium text-neutral-50">Lesrooster</h3>
        <p className="text-[14px] text-neutral-500 mt-2 max-w-md mx-auto">
          Weekoverzicht van alle lessen, aanwezigheid tracking en automatische herinneringen voor leden.
        </p>
