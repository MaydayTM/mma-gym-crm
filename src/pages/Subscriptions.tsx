    ...
    <div className="space-y-6 max-w-[1600px]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[14px] text-neutral-400 mt-1">Abonnementen en betalingen</p>
        </div>
        <button
      ...
      >
        <div className="w-16 h-16 mx-auto bg-emerald-500/10 rounded-2xl flex items-center justify-center mb-4">
          <CreditCard className="text-emerald-300" size={28} strokeWidth={1.5} />
        </div>
        <h3 className="text-[20px] font-medium text-neutral-50">Abonnementen Beheer</h3>
        <p className="text-[14px] text-neutral-500 mt-2 max-w-md mx-auto">
          Stripe integratie voor automatische betalingen, abonnement types, punch cards en trial periodes.
        </p>
